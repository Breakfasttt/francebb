...
export const questions: QuizQuestionData[] = [
  ...
  {
    category: "Règles",
    question: "Quelle météo oblige les joueurs à réussir un test de 3+ pour Foncer (fail sur 1-2) ?",
    options: ["Canicule", "Pluie battante", "Blizzard", "Climat tempéré"],
    correctIndex: 2,
    explanation: "Dans le Blizzard, Foncer (Rush) est plus difficile et échoue sur un 1 ou un 2 naturel."
  },
  {
    category: "Règles",
  ...
  {
    category: "Règles",
    question: "Que se passe-t-il si un joueur rate un ramassage de balle ?",
    options: ["Le ballon rebondit et Turnover", "Le ballon est perdu", "Le joueur peut rejouer", "Interception"],
    correctIndex: 0
  },
  {
    category: "Règles",
  ...
  {
    category: "Règles",
    question: "Quelle météo rend les tests de 'Foncer' plus difficiles (échec sur 1-2) ?",
  ...
  {
    category: "Équipes",
    question: "Quelle équipe n'a pas accès à un Apothicaire (ni assistant funéraire/médecin) ?",
    options: ["Morts-Ambulants", "Orques", "Humains", "Khorne"],
    correctIndex: 0,
    explanation: "Les équipes de Morts-Ambulants (Shambling Undead) ne peuvent pas recruter d'apothicaire."
  },
  {
    category: "Équipes",
  ...
  // === STAR PLAYERS (50) ===
  {
    ...
    question: "Combien coûte Griff Oberwald pour une équipe de la Noblesse ou Humaine ?",
  ...
  {
    category: "Compétences",
    question: "Quel trait possède un Bloqueur Saurus dans cette version (S3) ?",
    options: ["Esquive", "Juggernaut", "Blocage", "Minus"],
    correctIndex: 1,
    explanation: "Dans cette version bonifiée, les Saurus commencent avec Juggernaut et Instable."
  },
  {
    category: "Compétences",
  ...
  {
    category: "Compétences",
    question: "Quelle compétence permet d'augmenter son Armure de +1 lors d'un match via une prière ?",
    options: ["Homme de Fer", "Peau de Pierre", "Costaud", "Gros Bras"],
    correctIndex: 0,
    explanation: "La prière 'Homme de Fer' permet d'améliorer l'Armure d'un joueur de +1."
  },
  {
    category: "Compétences",
  ...
  },
  {
    category: "Compétences",
    question: "Quel est l'effet de 'Décomposition' ?",
    options: ["+1 sur les jets de blessure/élimination subis", "Le joueur sent mauvais", "Donne -1 en Armure", "Le joueur meurt tout de suite"],
    correctIndex: 0,
    explanation: "Le trait Décomposition (Decay) rend les blessures plus graves."
  },
  {
    category: "Compétences",
