...
export const questions: QuizQuestionData[] = [
  ...
  },
  {
    ...
    options: ["Réception réussie par chance", "Le ballon rebondit", "è‰chec automatique et Turnover si c'était le tour de l'équipe", "Le joueur se blesse"],
    correctIndex: 2
  },
  {
    category: "Règles",
  ...
  {
    category: "Règles",
    question: "Combien de cases peut-on parcourir au maximum en 'Fonè§ant' (GFI) ?",
  ...
  {
    category: "Règles",
    question: "Que se passe-t-il sur un résultat 'Riot' (è‰meute) au coup d'envoi ?",
  ...
  {
    category: "quipes",
    question: "Combien coè»te une équipe d'Ogres (Ogre seul) dans la liste d'armée ?",
  ...
  {
    category: "quipes",
    question: "Quelle équipe possède la règle spéciale 'Maè®tres de la Non-vie' ?",
    options: ["Khorne", "Morts-vivants", "Skavens", "Nains"],
    correctIndex: 1
  },
  {
    category: "quipes",
    question: "Combien coè»te un relance d'équipe (Re-roll) pour les Humains à la création ?",
  ...
  {
    category: "quipes",
    question: "Combien coè»te une relance pour une équipe d'Ogres ?",
  ...
  {
    category: "quipes",
    question: "Combien coè»te un Treeman (Homme-arbre) ?",
  ...
  {
    category: "quipes",
    question: "Combien coè»te un 'Khornigor' ?",
  ...
  {
    category: "quipes",
    question: "Combien coè»te un 'Lanceur' Humain ?",
  ...
  {
    category: "quipes",
    question: "Combien coè»te un Trois-quart Elfe Sylvain ?",
    options: ["60k", "70k", "80k", "90k"],
    correctIndex: 1
  },
  {
  ...
  {
    category: "Positionnels",
    question: "Quel est le score d'Agilité (AG) d'un 'Coureur d'è‰gouts' Skaven ?",
    options: ["2+", "3+", "4+", "5+"],
    correctIndex: 0
  },
  {
  ...
  },
  {
    ...
    options: ["Passe & Prise Sè»re", "Passe & Esquive", "Blocage & Passe", "Chef"],
    correctIndex: 0
  },
  {
    category: "Positionnels",
  ...
  },
  {
    ...
    options: ["Prise Sè»re", "Blocage", "Esquive", "Tacle"],
    correctIndex: 0
  },
  {
    category: "Positionnels",
  ...
  },
  {
    ...
    options: ["Passe & Prise Sè»re", "Passe & Chef", "Esquive & Passe", "Blocage & Passe"],
    correctIndex: 0
  },
  {
    category: "Positionnels",
  ...
  },
  {
    ...
    options: ["Blocage & Glissade Contrè´lée", "Blocage & Esquive", "Blocage & Tacle", "Blocage & Nerfs d'Acier"],
    correctIndex: 0
  },
  {
    category: "Positionnels",
  ...
  },
  {
    ...
    options: ["Frénésie, Esquive & Saut", "Frénésie & Blocage", "Frénésie & Tacle", "Frénésie & Glissade Contrè´lée"],
    correctIndex: 0
  },
  {
    category: "Positionnels",
  ...
  // === STAR PLAYERS (50) ===
  {
    category: "Star Players",
    question: "Combien coè»te Griff Oberwald pour une équipe de la Noblesse ?",
  ...
  },
  {
    ...
    options: ["Bolgrot l'è‰crabouilleur", "Grim Croc", "Glotl Stop", "Bob Bifford"],
    correctIndex: 0
  },
  {
    category: "Star Players",
    question: "Combien coè»te Deeproot Strongbranch (Hautbocage) ?",
    options: ["250k", "280k", "300k", "320k"],
    correctIndex: 2
  },
  {
  ...
  {
    category: "Star Players",
    question: "Combien coè»te Kreek 'The Verminator' Rustgouger ?",
  ...
  {
    category: "Star Players",
    question: "Quel Star Player est connu pour sa tronè§onneuse et son nom 'Helmut' ?",
  ...
  {
    category: "Star Players",
    question: "Combien coè»te 'Morg 'n' Thorg' ?",
  ...
  {
    category: "Star Players",
    question: "Combien coè»te 'Eldril Sidewinder' ?",
  ...
  {
    category: "Star Players",
    question: "Quel Star Player est un 'Tronè§onneur' Gobelin très célèbre ?",
    options: ["Helmut Wulf", "Nobbla Blackwart", "Ugroth Bolgrot", "Fungus the Loon"],
    correctIndex: 1
  },
  {
    category: "Star Players",
    question: "Combien coè»te 'Roxanna Darko' ?",
  ...
  {
    category: "Star Players",
    question: "Combien coè»te 'Grashnak Blackhoof' ?",
  ...
  {
    category: "Star Players",
    question: "Combien coè»te 'Ivar Eriksson' ?",
  ...
  {
    category: "Star Players",
    question: "Combien coè»te 'Glart Smashrip' ?",
  ...
  {
    category: "Star Players",
    question: "Combien coè»te 'Thrud le Barbare' (dans les anciennes éditions) ?",
  ...
  },
  {
    ...
    options: ["Maple Highgrove (è‰rable Hautbocage)", "Deeproot", "Willow", "Oakley"],
    correctIndex: 0
  },
  {
    category: "Star Players",
  ...
  {
    category: "Star Players",
    question: "Combien coè»te 'Lord Borak the Despoiler' ?",
  ...
  {
    category: "Star Players",
    question: "Quel Star Player possède la règle 'Casse-croè»te' ?",
    options: ["Guffle Pusmaw", "Bilerot", "Morg", "Varag"],
    correctIndex: 0
  },
  {
    category: "Star Players",
    question: "Combien coè»te 'Zolcath the Forsaken' ?",
  ...
  {
    category: "Star Players",
    question: "Combien coè»te 'The Black Gobbo' (Gobbo le Noir) ?",
  ...
  {
    category: "Comptences",
    question: "Quel est l'effet de 'Chè¢taigne (+1)' ?",
  ...
  },
  {
    ...
    options: ["Saut", "Esquive", "Glissade Contrè´lée", "Stabilité"],
    correctIndex: 1
  },
  {
    category: "Comptences",
  ...
  },
  {
    ...
    options: ["Permet de choisir la case oè¹ l'adversaire est poussé", "Permet de lancer le ballon plus loin", "Permet de lancer un coéquipier", "Permet de prédire le futur"],
    correctIndex: 0
  },
  {
    category: "Comptences",
  ...
  },
  {
    ...
    options: ["Retient les adversaires qui tentent de s'échapper", "Permet de porter 4 objets", "Donne Agilité 1+", "è‰trangle l'adversaire"],
    correctIndex: 0
  },
  {
    category: "Comptences",
  ...
  {
    category: "Comptences",
    question: "Que fait 'Crè¢ne è‰pais' ?",
  ...
  },
  {
    ...
    options: ["Le joueur n'agit sur un 1-3 que s'il bloque ou blitz", "Le joueur mange ses coéquipiers", "Le joueur est incontrè´lable", "Le joueur est un Minotaure"],
    correctIndex: 0
  },
  {
    category: "Comptences",
  ...
  },
  {
    ...
    options: ["Permet à un joueur de se déplacer de 3 cases lors du coup d'envoi", "Permet de renvoyer le ballon", "Fait plus de dégè¢ts", "Relance le dé"],
    correctIndex: 0
  },
  {
    category: "Comptences",
  ...
  },
  {
    ...
    options: ["Le Seigneur des Mouches", "Le Dieu du Sang", "Le Prince du Plaisir", "Le Maè®tre du Changement"],
    correctIndex: 0
  },
  {
    category: "Autre",
  ...
  {
    category: "Autre",
    question: "Combien coè»te une 'Relance d'è‰quipe' pour des Humains ?",
    options: ["50k", "60k", "70k", "100k"],
    correctIndex: 0
  },
  {
  ...
  },
  {
    ...
    options: ["La fin immédiate du tour de l'équipe active", "Une pè¢tisserie", "Un changement de cè´té", "Une faute"],
    correctIndex: 0
  },
  {
    category: "Autre",
