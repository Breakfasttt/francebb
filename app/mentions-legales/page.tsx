...
export default function MentionsLegalesPage() {
  ...
  return (
    <div className="mentions-page-wrapper">
      <PageHeader 
        title="Mentions Légales" 
        subtitle="Informations réglementaires et respect de la vie privée"
      />

      <main className="container mentions-container">
        <div className="mentions-grid">
          <PremiumCard className="mentions-section">
            ...
            <p>
              Le code source de la plateforme est ouvert et disponible sur <a href="https://github.com/Breakfasttt/francebb" target="_blank" rel="noopener noreferrer">GitHub</a> sous licence <strong>MIT</strong>. Toute réutilisation doit mentionner l'auteur original.
            </p>
            <p>
          ...
          <PremiumCard className="mentions-section">
            ...
            <ul>
              ...
              <li>Suivi des statistiques de la plateforme</li>
              <li>Affichage sur la carte communautaire</li>
            </ul>
            <p>
              Aucune donnée n'est cédée ou vendue à des tiers. Les statistiques techniques (taille BDD, quota mails) sont réservées à l'administration.
            </p>
          </PremiumCard>
        ...
        <div className="mentions-footer">
          <p>Dernière mise à jour : 24 Avril {currentYear}</p>
